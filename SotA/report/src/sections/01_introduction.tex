...
These dynamics violate the Stable Unit Treatment Value Assumption (SUTVA), as a treatment applied to one unit may affect outcomes in neighboring units and in future time periods \cite{pollmann_causal_2023, papadogeorgou_causal_2022}.
...
\Cref{sec:spatio_temporal} discusses the challenges and solutions regarding spatial and temporal data, followed by an outline of the theoretical foundations of DML and its extensions in \cref{sec:dml}.
