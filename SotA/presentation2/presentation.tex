...
\subtitle{State-of-the-Art Report | Scientific Computing Center (SCC) -- Methods for Big Data}
...
\begin{frame}{Double Machine Learning}{DML for Dynamic Treatment Effects (Lewis \& Syrgkanis 2021)}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
